...
public class ColourLineView extends View{
    ...
    public void initAttr(Context context, AttributeSet attrs){
        ...
        item_width = typedArray.getDimension(R.styleable.ColourLineView_item_width, 40);
        separation_width = typedArray.getDimension(R.styleable.ColourLineView_separation_width, 40);
        lean_degree = typedArray.getDimension(R.styleable.ColourLineView_lean_degree, 5);
        first_color = typedArray.getColor(R.styleable.ColourLineView_first_color, getResources().getColor(R.color.line_red));
        second_color = typedArray.getColor(R.styleable.ColourLineView_second_color, getResources().getColor(R.color.line_blue));
