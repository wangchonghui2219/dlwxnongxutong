...
public class HostProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context ctx;
    private List<NewProductBean.InfoBean> products;

    public HostProductAdapter(Context ctx,List<NewProductBean.InfoBean> products) {
        super();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyViewHolder) holder).cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (products.get(position).getGc() != null) {
                ...
                intent.putExtra("mobile",products.get(position).getMobile());
